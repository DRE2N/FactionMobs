...
import com.gmail.scyntrus.ifactions.f6.*;
...
public class FactionListenerFXL implements Listener {

    @EventHandler(priority = EventPriority.MONITOR, ignoreCancelled = true)
    public void onFactionRename(io.github.dre2n.factionsxl.event.FactionRenameEvent e) {
    ...
    @EventHandler(priority = EventPriority.MONITOR, ignoreCancelled = true)
    public void onFactionDisband(io.github.dre2n.factionsxl.event.FactionDisbandEvent e) {
